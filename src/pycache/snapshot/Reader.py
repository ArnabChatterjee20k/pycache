...
class Reader:
    ...
    def _read_string(self,key_length=None):
        ...
        if encoding == Encoder.INT8:
            ...
            return self.buffer.read(key_length if key_length else original_length).decode('utf-8')
    ...
    def _read_key_value(self):
        ...
        key_length = self._read_length()
        key = self._read_string(key_length)
        value = self._read_string()
        return key,value_datatype(value)